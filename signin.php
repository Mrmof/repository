    ...
    <div class="container">
      <div class="row">
          <div class="col-lg-4 col-md-6 offset-md-3 col-12 offset-lg-4 mt-5">
            ...
            <form action="<?=ROOT_URL?>php/controller/signin.php" method="post" class="mb-5" data-aos="fade-up" data-aos-delay="400">
              <div class="row">
                <small>
                  <?php 
                ...
                <div class="col-12 mb-2">
                  <input type="text" name="identity" class="form-control" placeholder="Mat No. or email" required="">
                </div>
