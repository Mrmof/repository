    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up" class="">Welcome to <span><?=$schoolName?></span></h1>
          <p data-aos="fade-up" data-aos-delay="100" class="">Quickly start access and get past research project now and set the stage for success<br></p>
